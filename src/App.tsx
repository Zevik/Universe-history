                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute right-1/2 transform translate-x-1/2 z-10">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center shadow-lg cursor-pointer">
                        <span className="text-white font-bold">{index + 1}</span>
                      </div>
                    </div>

                    {/* Event card */}
                    <div className={`w-5/12 ${isLeft ? 'mr-auto pl-8' : 'ml-auto pr-8'}`}>
                      <motion.div
                        whileHover={{ scale: 1.02 }}
                        className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg p-6 cursor-pointer border border-white/20 hover:border-blue-300 transition-all duration-300"
                      >
                        ...
                        <div className="flex items-center gap-2 mb-3">
                          <span className="text-sm text-gray-300">חשיבות:</span>
